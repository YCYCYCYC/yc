...
function canMoveUp() {
    ...
    return false;//任务3：实现判断是否可以向上的逻辑
}
...
function canMoveRight() {
    ...
    return false; //任务5：实现判断是否可以向右的逻辑
}
...
function canMoveDown() {
    ...
    return false;   //任务7：实现判断是否可以向下的逻辑
}
...
function noBlockVertical(col, row1, row2, nums) {
    ...
    return true; //任务8：实现判断垂直方向上是否有障碍物
}
